//
//  UIBarButtonItem+WSCategory.m
//  iMedia
//
//  Created by meng qian on 12-11-16.
//  Copyright (c) 2012年 Li Xiaosi. All rights reserved.
//

#import "UIBarButtonItem+WSCategory.h"

@implementation UIBarButtonItem (WSCategory)

-(void)drawRect:(CGRect)rect {
    UIImage *backImage = [UIImage imageNamed:@"barbutton_bg.png"];
    [backImage drawInRect:CGRectMake(0, 0, 41  ,29)];
}
